...
export const GamePromo = () => {
  return (
    <div className="game-promo">
      ...
      <img loading="lazy" src={`${BASE_URL}/img/gamePromo/animal1.jpg`} alt="image1" className="game-promo__img" />
      <img loading="lazy" src={`${BASE_URL}/img/gamePromo/animal2.webp`} alt="image2" className="game-promo__img" />
      </div>
